...
def raw_conversion(raw_image_path, converted_image_path, width=5472, height=3648, width_offset=0, height_offset=0):
    ...
    load_image = PySpin.Image.Create(width, height, width_offset, height_offset, PySpin.PixelFormat_BayerRG8, offline_data)
    ...
    result_image = processor.Convert(load_image,PySpin.PixelFormat_RGB8)
    # Save image
